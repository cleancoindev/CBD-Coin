...
int nAnonymizeGanjaProjectAmount = 1000;
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ...
               fprintf(ConfFile, "port=10559\n");
               fprintf(ConfFile, "rpcport=10560\n");
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "GanjaProjectd.pid"));
    ...
    if (vTimeOffsets.size() >= 5 && vTimeOffsets.size() % 2 == 1)
    {
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                {
                    fDone = true;
                    string strMessage = _("Warning: Please check that your computer's date and time are correct! If your clock is wrong GanjaProject will not work properly.");
