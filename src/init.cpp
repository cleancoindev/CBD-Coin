...
std::string HelpMessage()
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: GanjaProjectd.pid)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 10559)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeGanjaProjectamount=<n> " + _("Keep N GanjaProject anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    nAnonymizeGanjaProjectAmount = GetArg("-anonymizeGanjaProjectamount", 0);
    if(nAnonymizeGanjaProjectAmount > 999999) nAnonymizeGanjaProjectAmount = 999999;
    if(nAnonymizeGanjaProjectAmount < 2) nAnonymizeGanjaProjectAmount = 2;
